...
- FastAPI REST 서버 (`/health`, `/reduce`, `/reduce/pod`, `/twin/build`, `/twin/predict`, `/twin/benchmark`, `/twin/package`, `/twin/package/accept`, `/analytic/*`, `/simulate/lbm_cavity`, `/optimize/bayesian`)
