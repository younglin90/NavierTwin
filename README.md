...
- FastAPI REST 서버 (`/health`, `/doctor`, `/preflight`, `/reduce`, `/reduce/pod`, `/twin/build`, `/twin/predict`, `/twin/benchmark`, `/twin/package`, `/twin/package/inspect`, `/twin/package/verify`, `/twin/package/accept`, `/analytic/*`, `/simulate/lbm_cavity`, `/optimize/bayesian`)
...
- `POST /twin/predict` — 저장/배포된 `TwinEngine`의 파라미터→유동장 예측
