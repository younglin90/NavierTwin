"""Customer-facing runtime diagnostics for support and first-run checks."""
...
def _check_dependencies(
    ...
    *,
    ...
    packages = {
        display_name: _package_available(module_name)
...
def build_doctor_report(*, include_optional: bool = False) -> dict[str, Any]:
    """Build a deterministic diagnostic report for customer support.
