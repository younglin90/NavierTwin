...
CUSTOMER_SMOKE_TESTS = [
    ...
    "tests/test_explainability_panel_gui.py",
    "tests/test_export_panel_report_gui.py",
    "tests/test_fmu_export.py",
    ...
    "tests/test_main_window_explainability_gui.py",
    "tests/test_main_window_integration.py",
    "tests/test_main_window_operator_gui.py",
    "tests/test_main_window_postproc.py",
    "tests/test_main_window_recent_projects_gui.py",
    "tests/test_main_window_simulation_gui.py",
    "tests/test_main_window_support_bundle_gui.py",
    "tests/test_main_window_tutorial_gui.py",
    "tests/test_main_window_update_check_gui.py",
    "tests/test_model_compare_dashboard_gui.py",
    "tests/test_model_panel_active_learning_gui.py",
    "tests/test_model_panel_metadata.py",
    ...
    "tests/test_twin_panel_optimization_gui.py",
]
